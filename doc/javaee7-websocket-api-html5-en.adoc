...
v1.0, November 6, 2013: First English version
:toc:
...
:mdash: &#8212;
:language: asciidoc
:link-demo: http://wildfly-mgreau.rhcloud.com/usopen/matches.html
...
<8> AngularJS files to handle several matches (matches.html) with REST and WebSocket call
